...
if (isset($_POST['update_btn'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        //header('location:view_roko_product.php');
...
if (isset($_GET['delete'])) {
    ...
    if ($store == 'rokomari') {
        $sql = "DELETE FROM roko_bookstore WHERE id={$id}";
        ...
        $sql = "DELETE FROM othoba_bookstore WHERE id={$id}";
        $delete_data = mysqli_query($conn, $sql);
        if ($delete_data) {
            //header('location:view_othoba_product.php');
            echo "Data Deleted Successfully";
        }
    } else {
        $sql = "DELETE FROM priyo_bookstore WHERE id={$id}";
        $delete_data = mysqli_query($conn, $sql);
        if ($delete_data) {
            //header('location:view_priyo_product.php');
            echo "Data Deleted Successfully";
        }
    }
}
