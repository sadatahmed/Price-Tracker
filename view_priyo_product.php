                        ...
                        <tbody>
                            ...
                            <?php while ($row = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <td><a href="update_product.php?store=<?php echo $row['market_place']; ?>&&update=<?php echo $row['id']; ?>" class="btn btn-success">Update</a></td>
                                    <td><a href="update_product.php?store=<?php echo $row['market_place']; ?>&&delete=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                                </tr>
